...
var _surprisetalk$taysar$Test$post = {
	title: 'third',
...
var Elm = {};
Elm['Test'] = Elm['Test'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Test'], 'Test', typeof _surprisetalk$taysar$Test$main === 'undefined' ? null : _surprisetalk$taysar$Test$main);
