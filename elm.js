...
var _surprisetalk$taysar$Main$Decrement = {ctor: 'Decrement'};
var _surprisetalk$taysar$Main$Increment = {ctor: 'Increment'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_surprisetalk$taysar$Main$Decrement)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_surprisetalk$taysar$Main$Increment)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				_surprisetalk$taysar$Main$markdown)
			]));
};
var _surprisetalk$taysar$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: 0, view: _surprisetalk$taysar$Main$view, update: _surprisetalk$taysar$Main$update})
};
